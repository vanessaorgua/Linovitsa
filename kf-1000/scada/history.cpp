...
//    connect(m_ui->Cf_10cf1,SIGNAL(clicked()),this,SLOT(slotAccept()));
    connect(m_ui->kf_10presh1,SIGNAL(clicked()),this,SLOT(slotAccept()));
    connect(m_ui->kf_20presh2,SIGNAL(clicked()),this,SLOT(slotAccept()));
    connect(m_ui->kf_30presh3,SIGNAL(clicked()),this,SLOT(slotAccept()));

    connect(m_ui->trend0susp4,SIGNAL(clicked()),this,SLOT(slotAccept()));
    connect(m_ui->trend0voda4,SIGNAL(clicked()),this,SLOT(slotAccept()));
    connect(m_ui->trend0amvoda4,SIGNAL(clicked()),this,SLOT(slotAccept()));
